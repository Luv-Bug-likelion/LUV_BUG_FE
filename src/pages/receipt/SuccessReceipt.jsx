...
const SuccessReceipt = () => {
  ...
  return (
    <div className="check-container">
      <p style={{ color: '#111', fontSize: '20px', fontWeight:'500', marginTop:'27px'}}>{state.result.merchantName}</p>
      ...
      <div className="log-container">
        <div>
            ...
            <div className="date-container">
                ...
                <p style={{ color: '#111', fontSize: '14px', fontWeight:'500', marginLeft:'5px' }}>{state.result.visitDate}</p>
            </div>
        </div>
      ...
      <div className="amount-container">
        ...
        <p style={{ color: '#C46D48', fontSize: '20px', fontWeight:'500' }}>{state.result.totalAmount.toLocaleString()}원</p>
      </div>
